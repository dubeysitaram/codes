...
/** this code is single threaded as a single thread first enters the main function and execute the find odd function and
 * then it excutes the find even function so only single thread is doing the work
 * */
